...
<center><div>
	...
	<form action="alterar" method="post" enctype="multipart/form-data">
		<p>
			...
			<form:errors path="usuario.nome" style="text-align: center; color: red;"/> <!--validação fuciona, porem não exibe a msg-->
			<div class="form-group">
		<label for="nome">Nome:*</label>
	<input type="text" id="nome" class="form-control"name="nome" value="${usuario.nome}" style="width: 200px;" maxlength="100" />
</div>
			
	<form:errors path="usuario.matricula" style="text-align: center; color: red;"/> <!--validação fuciona, porem não exibe a msg-->
